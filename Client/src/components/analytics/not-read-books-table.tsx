...
import { notReadBooksAction } from "@/lib/student-actions";
...
type IntervalCheckinsResult = Book[] | null;

// Initial sample data
const initialRecord: Book[] = [];
...
export default function NotReadBooksTable() {
